...
export const movieService = {
    ...
    getMovies: (year:number | null,genretrue:number[],page:number): IRes<IPage<IMovie>> => axiosService.get(`${urls.discover}${urls.apiKey}${urls.withgenres}${genretrue}${urls.year}${year}${urls.page}${page}`),
